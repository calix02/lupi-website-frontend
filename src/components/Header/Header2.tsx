...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-7xl lg:rounded-full rounded-2xl border transition-all duration-500 ${
        scrolled
          ? "border-emerald-500/20 bg-slate-950/80 shadow-2xl shadow-emerald-950/20 backdrop-blur-2xl py-2.5 px-6"
