...
export default function Officials() {
  ...
  const viceMayor = {
    ...
    message:
      "Working hand-in-hand with the council to legislate programs that uplift every Lupinian family.",
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.p
            variants={animate.itemVariants}
            className="mt-3 max-w-xl text-base text-slate-600 font-medium"
          >
            Dedicated leaders serving Lupi with integrity, commitment, and
            vision.
          </motion.p>
        </motion.div>
        ...
        <div className="w-full mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 flex flex-col items-center text-center lg:items-start lg:text-left  p-6 sm:p-8 relative overflow-hidden">
              ...
              <motion.p
                variants={animate.itemVariants}
                className="text-base font-semibold text-emerald-700 mt-1"
              >
                Municipal Mayor
              </motion.p>
              ...
              <motion.div
                variants={animate.itemVariants}
                className="mt-6 pt-6 border-t border-slate-100 relative"
              >
                ...
                <p className="text-sm sm:text-base text-slate-600 italic leading-relaxed relative z-10">
                  "Ang ating layunin ay maghatid ng tapat, mabilis, at
                  de-kalidad na serbisyo para sa bawat pamilyang Lupinian.
                  Samahan ninyo kami sa pagbuo ng mas progresibong bayan."
                </p>
              </motion.div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm sm:text-base mb-6 leading-relaxed">
                  Highlighting the key initiatives and ongoing municipal
                  projects led under the administration of Mayor Christopher V.
                  Jacinto.
                </p>
