  ...
  return (
    <section className="w-full min-h-screen relative bg-slate-50 flex flex-col justify-between items-center overflow-hidden py-12 md:py-16">
      ...
      >
        ...
        <motion.p
          variants={itemVariants}
          className="max-w-2xl text-center text-slate-300 text-base sm:text-lg leading-relaxed mb-6"
        >
      ...
      <div className="h-[60vh]  absolute bottom-0 w-full bg-cover bg-top  pointer-events-none z-10 lg:block md:block hidden">
        <video
          autoPlay
          loop
          muted
