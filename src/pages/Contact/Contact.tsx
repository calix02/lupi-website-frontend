        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl flex flex-col items-center">
          ...
          >
            ...
            <p className="mt-3 max-w-2xl text-base sm:text-lg text-slate-600 font-medium">
              We are here to assist you. Send us a message or reach out through
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full">
            ...
            >
              ...
              <SocialCard
                ...
                borderColor2=" border-emerald-200"
                ...
                kind="Call Us"
                link="#"
                nameLink="+63 917 123-4567"
                tags="+63 917 123-4567(Hotline)"
              />
              ...
              <SocialCard
                icon={Mail}
                borderColor1="bg-teal-500"
                borderColor2=" border-teal-200"
                backgroundColor="bg-teal-100"
                textColor="text-teal-700"
                variants={itemVariants}
                title="Official Email"
                kind="Email Us"
                link="mailto:support@lupi.gov.ph"
                nameLink="info@lupi.gov.ph"
                tags="support@lupi.gov.ph"
              />

              {/* Facebook Social Card */}
              <SocialCard
                icon={ExternalLink}
                borderColor1="bg-blue-600"
                borderColor2=" border-blue-200"
                backgroundColor="bg-blue-100"
                textColor="text-blue-600"
                variants={itemVariants}
                title="Facebook Page"
                kind="Social Media"
                link="https://www.facebook.com/profile.php?id=100063643063038"
                nameLink="LGU Municipality of Lupi"
                tags="Follow us for real-time announcements & updates"
              />
              ...
              >
                ...
                <div className="relative z-10 space-y-3">
                  ...
                  <div className="flex items-start gap-2.5 text-slate-300 text-xs sm:text-sm">
                    ...
                    <span>
                      Poblacion, Lupi, Camarines Sur, Philippines 4409
                    </span>
                  </div>
            ...
            >
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-slate-500">
                      Fill out the form below and our staff will respond
                      promptly.
                    </p>
                  </div>
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="text-xs sm:text-sm text-slate-600 max-w-md">
                      Thank you for reaching out to LGU Lupi. Your inquiry has
                      been routed to the appropriate department.
                    </p>
                  </motion.div>
                ) : (
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 text-center">
                <p className="text-[11px] text-slate-400 font-medium">
                  Your personal details are protected in accordance with the
