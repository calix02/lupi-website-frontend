  ...
  const projectsData: ProjectItem[] = [
    {
      ...
      description:
        "2.5 km concrete road expansion connecting rural agricultural barangays to the main economic hub.",
    ...
    },
    {
      ...
      description:
        "State-of-the-art 2-story command center equipped with emergency response logistics and staging area.",
    ...
    },
    {
      ...
      category: "Healthcare",
      description:
        "Upgrade of medical diagnostics equipment and expansion of patient treatment capacity.",
    ...
    },
    {
      ...
      category: "Infrastructure",
      description:
        "Reinforced concrete box culverts installation along main arterial roads to prevent localized flooding.",
    ...
    },
    {
      ...
      category: "Energy",
      description:
        "Installation of 350 eco-friendly smart solar LED lighting poles along national highway corridors.",
    ...
    },
    {
      ...
      category: "Commerce",
      description:
        "Comprehensive overhaul of wet market sections, sanitation systems, and modern stall layouts.",
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 mt-5 rounded-full bg-emerald-100/80 border border-emerald-200/80 text-emerald-800 text-xs font-semibold tracking-wider uppercase backdrop-blur-md shadow-xs">
            ...
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
              Real-time public reporting on capital expenditures, contractor
              allocations, and ongoing infrastructure projects for the
              municipality.
            </p>
          </motion.div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Animated 3D visual breakdown of municipal projects
                  </p>
                </div>
                      ...
                      <tr>
                        ...
                        >
                          <p className="text-sm font-semibold">
                            No municipal projects match your search.
                          </p>
                        </td>
                      </tr>
                    )}
